...
{
    private static final byte[] ZERO_BYTES = new byte[] {42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42};
    private static final Slice ZERO_SLICE = Slices.wrappedBuffer(ZERO_BYTES);
