...
- **singlenode-ldap** - Three single node Docker containers, one running OpenLDAP
 server, another with SSL/TLS certificates installed on top of a single node Presto
 installation, and third one with a pseudo-distributed Hadoop installation
