...
import static com.facebook.presto.spi.StandardErrorCode.NUMERIC_UNDERFLOW;
        ...
        extends AbstractTestFunctions
{
    ...
    public void testOverflowAdd()
            throws Exception
    {
        assertInvalidFunction(format("%s + 1", Long.MAX_VALUE), NUMERIC_OVERFLOW);
    }
            ...
            throws Exception
    {
        ...
        assertInvalidFunction(format("%s - 2", minValue), NUMERIC_UNDERFLOW);
    }
    ...
    public void testOverflowMultiply()
            throws Exception
    {
        assertInvalidFunction(format("%s * 2", Long.MAX_VALUE), NUMERIC_OVERFLOW);
        //assertInvalidFunction(format("%s * -1", Long.MIN_VALUE), NUMERIC_OVERFLOW); TODO: uncomment when https://github.com/facebook/presto/issues/4571 is fixed
    }
    ...
    public void testNegateOverflow()
            throws Exception
    {
        //assertInvalidFunction(format("-(%s)", Long.MIN_VALUE), NUMERIC_OVERFLOW); TODO: uncomment when https://github.com/facebook/presto/issues/4571 is fixed
    }
}
