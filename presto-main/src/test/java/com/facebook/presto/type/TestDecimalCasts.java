        ...
        extends AbstractTestFunctions
{
    ...
    public void testDecimalToFloatCasts()
    {
        ...
        assertFunction("CAST(CAST(DECIMAL '0' AS DECIMAL(20, 2)) AS FLOAT)", FLOAT, 0.0f);
        assertFunction("CAST(CAST(DECIMAL '12.12' AS DECIMAL(20, 2)) AS FLOAT)", FLOAT, 12.12f);
        assertFunction("CAST(DECIMAL '1234567890.1234567890' AS FLOAT)", FLOAT, 1234567890.1234567890f);
        assertFunction("CAST(DECIMAL '-1234567890.1234567890' AS FLOAT)", FLOAT, -1234567890.1234567890f);
        assertFunction("CAST(DECIMAL '-1234567890123456789012345678' AS FLOAT)", FLOAT, -1.2345678901234569E27f);
        assertFunction("CAST(DECIMAL '99999999999999999999999999999999999999' AS FLOAT)", FLOAT, 1.0E38f);
    }
