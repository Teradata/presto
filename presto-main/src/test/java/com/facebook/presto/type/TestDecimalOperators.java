        ...
        extends AbstractTestDecimalFunctions
{
            ...
            throws Exception
    {
        ...
        assertInvalidFunction("DECIMAL .1234567890123456789 * DECIMAL .12345678901234567890", "DECIMAL scale would exceed 38 after multiplication");
        assertInvalidFunction("DECIMAL .1 * DECIMAL .12345678901234567890123456789012345678", "DECIMAL scale would exceed 38 after multiplication");
