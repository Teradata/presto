...
public class TestTypeRegistry
{
    ...
    public void testCanCoerce()
    {
        ...
        assertTrue(canCoerce("row<bigint,double,varchar>('a','b','c')", "row<bigint,double,varchar>('a','b','c')"));
        ...
        assertTrue(canCoerce("varchar(44)", "varchar"));
        assertTrue(canCoerce("unknown", "varchar"));
        assertTrue(canCoerce("unknown", "varchar(44)"));

        assertTrue(canCoerce("decimal(22,1)", "decimal(23,1)"));
        assertTrue(canCoerce("decimal", "decimal(38,1)"));
