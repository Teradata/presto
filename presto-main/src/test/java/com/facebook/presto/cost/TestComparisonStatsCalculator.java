...
public class TestComparisonStatsCalculator
{
    ...
    public void symbolToSymbolEqualStats()
    {
        ...
        // None of the ranges is included in the other
        rowCount = 8.4375;
        ...
        // None of the ranges is included in the other, and one symbol has much higher cardinality, so that has more NDV in intersect than the other in total
        rowCount = 1.125;
