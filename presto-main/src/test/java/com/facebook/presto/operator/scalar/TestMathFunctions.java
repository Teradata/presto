        ...
        extends AbstractTestFunctions
{
    ...
    public void testRound()
    {
        ...
        assertFunction("round(DECIMAL '3', 0)", createDecimalType(1, 0), SqlDecimal.of("3"));
        assertFunction("round(DECIMAL '-3', 0)", createDecimalType(1, 0), SqlDecimal.of("-3"));
        ...
        assertFunction("round(DECIMAL '-9.9', 0)", createDecimalType(3, 1), SqlDecimal.of("-10.0"));
        assertFunction("round(DECIMAL '123456789012345678', 0)", createDecimalType(18, 0), SqlDecimal.of("123456789012345678"));
        assertFunction("round(DECIMAL '-123456789012345678', 0)", createDecimalType(18, 0), SqlDecimal.of("-123456789012345678"));
        ...
        assertFunction("round(DECIMAL '-999999999999999999.9', 0)", createDecimalType(20, 1), SqlDecimal.of("-1000000000000000000.0"));
        assertFunction("round(CAST(NULL as DECIMAL(1,0)), 0)", createDecimalType(1, 0), null);
        ...
        assertFunction("round(DECIMAL '-9.99', 1)", createDecimalType(4, 2), SqlDecimal.of("-10.00"));
        assertFunction("round(DECIMAL '123456789012345678', 1)", createDecimalType(18, 0), SqlDecimal.of("123456789012345678"));
        assertFunction("round(DECIMAL '-123456789012345678', 1)", createDecimalType(18, 0), SqlDecimal.of("-123456789012345678"));
        ...
        assertFunction("round(DECIMAL '-1234.5678', -7)", createDecimalType(9, 4), SqlDecimal.of("0.0000"));
        assertFunction("round(DECIMAL '123456789012345678', 7)", createDecimalType(18, 0), SqlDecimal.of("123456789012345678"));
        assertFunction("round(DECIMAL '-123456789012345678', 7)", createDecimalType(18, 0), SqlDecimal.of("-123456789012345678"));
