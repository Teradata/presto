        ...
        extends SqlAggregationFunction
{
    ...
    {
        Type inputType = typeManager.getType(resolveCalculatedType(getSignature().getArgumentTypes().get(0), boundVariables.getLongVariables()));
        Type outputType = typeManager.getType(resolveCalculatedType(getSignature().getReturnType(), boundVariables.getLongVariables()));
