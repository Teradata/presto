    ...
    implements HashAggregationBuilder
{
    ...
    private CompletableFuture<?> spillToDisk()
    {
        ...
        if (!spiller.isPresent()) {
            spiller = Optional.of(spillerFactory.create(hashAggregationBuilder.buildTypes(), () -> operatorContext.getSpillContext().newLocalSpillContext(), operatorContext.getSystemMemoryContext().newAggregatedMemoryContext()));
        }
