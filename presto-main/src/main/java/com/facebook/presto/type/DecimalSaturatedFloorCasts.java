...
public final class DecimalSaturatedFloorCasts
{
    ...
    {
        return bigDecimalToBigintFloorSaturatedCast(BigDecimal.valueOf(intBitsToFloat((int) value)), resultPrecision, resultScale).longValueExact();
    }

    @UsedByGeneratedCode
    public static Slice floatToLongDecimal(long value, int resultPrecision, int resultScale)
    {
        return encodeUnscaledValue(bigDecimalToBigintFloorSaturatedCast(BigDecimal.valueOf(intBitsToFloat((int) value)), resultPrecision, resultScale));
    }
