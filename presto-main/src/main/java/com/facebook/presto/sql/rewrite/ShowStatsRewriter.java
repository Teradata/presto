...
public class ShowStatsRewriter
{
    ...
    public ShowStatsRewriter(Metadata metadata, Session session, List<Expression> parameters, QueryExplainer queryExplainer)
    {
    ...
    public Node rewrite(ShowStats node)
    {
